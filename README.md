...
- **Database**: SQLite (offline development database, compatible with Linux and ARM64)
...
- SQLite (included through the EF Core SQLite provider)
...
The database file is created automatically in the application directory when the application starts.
